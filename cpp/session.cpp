...
Session::Session(QObject *parent)
    ...
    , m_diskCacheSize(BITTORRENT_SESSION_KEY("DiskCacheSize"), 12287)
    ...
    , m_torrentContentLayout(BITTORRENT_SESSION_KEY("TorrentContentLayout"), TorrentContentLayout::Subfolder)
